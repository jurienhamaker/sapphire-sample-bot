...
}), _dec2 = (0, _decorators.RequiresPermissions)('MANAGE_MESSAGES'), _dec3 = (0, _decorators.RequiresGuildContext)(message => message.channel.send('This command can only be used in servers')), _dec4 = (0, _decorators.RequiresDMContext)(message => message.channel.send('This command can only be used in DMs')), _dec(_class = (_class2 = class UserCommand extends _pluginSubcommands.SubCommandPluginCommand {
